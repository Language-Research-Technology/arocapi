...
describe('Integration Tests', () => {
  ...
  describe('GET /entity/:id', () => {
    ...
    it('should return File entity from database', async () => {
      ...
      expect(body.entityType).toBe('http://pcdm.org/models#File');
  ...
  describe('GET /entities', () => {
    ...
    it('should filter entities by File entityType', async () => {
      ...
      expect(body.entities[0].entityType).toBe('http://pcdm.org/models#File');
      expect(body.entities[1].entityType).toBe('http://pcdm.org/models#File');
    });
  ...
  describe('POST /search', () => {
    ...
    it('should filter search results by File entityType', async () => {
      ...
      expect(response.statusCode).toBe(200);
      expect(body.entities.every((e) => e.entityType === 'http://pcdm.org/models#File')).toBe(true);
    });
    ...
    it('should include File entityType in facet aggregations', async () => {
      ...
      expect(body.facets.entityType[1].name).toBe('http://pcdm.org/models#File');
    });
    ...
    it('should search for File entities by name', async () => {
      ...
      expect(audioFile?.entityType).toBe('http://pcdm.org/models#File');
    });
  });
