  ...
  describe('GET /entity/:id/crate', () => {
    it('should stream RO-Crate metadata for File entity', async () => {
      ...
      const response = await fastify.inject({
        method: 'GET',
        url: `/entity/${encodeURIComponent('http://example.com/entity/file.wav')}/crate`,
      });
    ...
    it('should stream RO-Crate metadata for Collection entity', async () => {
      ...
      const response = await fastify.inject({
        method: 'GET',
        url: `/entity/${encodeURIComponent('http://example.com/collection')}/crate`,
      });
    ...
    it('should stream RO-Crate metadata for Object entity', async () => {
      ...
      const response = await fastify.inject({
        method: 'GET',
        url: `/entity/${encodeURIComponent('http://example.com/object')}/crate`,
      });
    ...
    it('should return 404 when entity not found', async () => {
      ...
      const response = await fastify.inject({
        method: 'GET',
        url: `/entity/${encodeURIComponent('http://example.com/nonexistent')}/crate`,
      });
